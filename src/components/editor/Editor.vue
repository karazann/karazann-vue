...
<script lang="ts">
    import { Editor, EditorNode, Node, NodeBuilder, Output, Input, Pin, PinType, EditorConnection } from '@/shared/flow'
    ...
    class Console extends NodeBuilder {
        ...
        build(node: Node) {
            ...
            node.addInput(new Input('test', new Pin('fdsaf', PinType.Data)))
